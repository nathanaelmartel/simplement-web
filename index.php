...
<div class="grid-container boxes">
  ...
  <div class="grid-25 tablet-grid-50 mobile-grid-100">
	  <a href="/integration-developpement-frontend" class="box box-front" title="Détail de la prestation en matière de Développement Front End">
  ...
  <div class="grid-25 tablet-grid-50 mobile-grid-100">
    <a href="/responsive-design" class="box box-responsive-design" title="Détail de la prestation de passage au mobile">
      <h1>Adaptation pour le Web&nbsp;mobile</h1>
      <ul>
  ...
  <div class="grid-25 tablet-grid-50 mobile-grid-100">
    <a href="/ergonomie-accessibilite" class="box box-ergonomie-accessibilite" title="Détail des compétences d'ergonomie et d'accessibilité">
      <h1>Audit de site&nbsp;Web</h1>
      <ul>
  ...
  <div class="grid-25 tablet-grid-50 mobile-grid-100">
    <a href="/devoloppment-web" class="box box-back" title="Détail des prestation en matière de développement">
      <h1>Développement Web sur&nbsp;Mesure</h1>
      <ul>
        <li>PHP</li>
        <li>Symfony 1 et 2</li>
        <li>WordPress</li>
        <li>Piwik</li>
