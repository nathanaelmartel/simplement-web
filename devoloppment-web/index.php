...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
  ...
  <head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="title" content="Développement Web - simplement Web" />
<meta name="robots" content="index, follow" />
    <title>Développement Web - simplement Web</title>
...
<div class="grid-container content">
  <div class="grid-60 tablet-grid-50 mobile-grid-100 section">
    <section>
      ...
      <p>Je ne me contente pas de faire des prototypes, je les intègres ensuite dans des outils adaptés à la gestion d'un site, que ce soit le CMS wordPress, le framework symfony ou le moteur e-commerce Magento.</p>

      <h2>WordPress</h2>

      <p>Je réalise un template et configure votre site. Je peux également vous conseiller dans la hierarchisation de l'information et saisir les premiers contenus.</p>

      <p>Mon expérience me permet également de vous conseiller les plugings correspondant à vos besoins.</p>

      <p>Au final, vous disposez d'un site clés en main.</p>

      <h2>Symfony</h2>

      <p>J'ai une grande expérience de ce framework et je suis tout à fait en mesure de me joindre à un projet et son équipe.</p>

      <h2>Référencement / <abbr title="Search Engine Optimisation">SEO</abbr></h2>

      <p>Je peux vous conseiller et/ou mettre en place un certain nombre de techniques efficaces, que ce soit en terme de sémantique, d'organisation de l'information ou encore de maillage interne…</p>
  ...
  <div class="grid-40 tablet-grid-50 mobile-grid-100 aside">
    <aside>
      <div class="box box-back">
        ...
        <p>Devis sur demande : <a href="/contact">contactez moi</a></p>
        <div class="h1">Back End</div>
        <ul>
          <li>symfony 1</li>
          <li>Symfony 2</li>
          <li>symfony + apostrophe</li>
          <li>WordPress</li>
          <li>PHP</li>
          <li>MySQL</li>
          <li>Piwik</li>
          <li>Référencement / <abbr title="Search Engine Optimisation">SEO</abbr></li>
        </ul>
      </div>
    </aside>
  </div>
