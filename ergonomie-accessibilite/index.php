...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
  ...
  <head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="title" content="Audit - simplement Web" />
<meta name="robots" content="index, follow" />
    <title>Audit - simplement Web</title>
...
<div class="grid-container content">
  <div class="grid-60 tablet-grid-50 mobile-grid-100 section">
    <section>
      <h1>Ergonomie &amp; Accessibilité</h1>

      <p>Faire un site est une chose, le rendre utilisable à tous en est une autre.</p>

      <h2>Audit</h2>

      <p>En partant de votre site, je réalise un état des lieux complet et détaillé en prenant en compte toutes une série de points : </p>
      ...
      <p>Le rapport propose les solutions les plus efficace («quick win») à mettre en place pour améliorer significativement votre site web.</p>

      <h2>Prototype fonctionel</h2>

      <p>Dans le cadre d'une refonte où d'un nouveau projet, une des premières étape est la réalisation d'un «zonning» définissant la manière de disposer le contenu.</p>
      <p>Ce «zonning», réalisé comme une page web, est un verritable prototype fonctionel permettant de préparer l'habillage et de tester les principes de navigation ainsi le rendu sur toutes sorte de support comme les smartphones.</p>
  ...
  <div class="grid-40 tablet-grid-50 mobile-grid-100 aside">
    <aside>
      <div class="box box-ergonomie-accessibilite">
        <div class="h1">Audit</div>
        <ul>
          <li>Rapport détaillé</li>
          <li>Suggestion de «Quick win»</li>
          <li>Pour <strong>950 €</strong></li>
        </ul>
        <div class="h1">Prototype</div>
        <ul>
          <li>Agencement du contenu</li>
          <li>Animations et Interactions</li>
          <li>Adapté aux différents supports</li>
        </ul>
